...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!context.ServiceCategories.Any())
    {
        ...
        context.Services.AddRange(
            ...
            new Service { ServiceId = 6, ServiceName = "VIP Trẻ Hóa Hoàng Gia", Description = "Trải nghiệm liệu trình chống lão hóa đỉnh cao with tinh chất vàng 24K, đem lại diện mạo thanh xuân ngay lần đầu.", Price = 2000000, Duration = 180, IsActive = true, IsVip = true, MaxCapacity = 10, Image = "https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=600&q=80", CategoryId = cat.Id }
        );
        context.SaveChanges();
    }
